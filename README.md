...
I built this program to understand how Python and Javascript work with API's, and to share my understanding and work process with others. I built this program first with [Python](https://github.com/phillipashford/weather-tracker/blob/main/weather_tracker.py), then converted it to vanilla [JavaScript](https://github.com/phillipashford/weather-tracker/blob/main/weatherTracker.js) before deciding to create a react app to add the more advanced features. I'm retiring this repo and working on the advanced fatures over in the [React repo](https://github.com/phillipashford/weather-app) but leaving this repo open to demonstrate my work with Python and vanilla JavaScript. 
...
___
These features are being implemented in the [React repo](https://github.com/phillipashford/weather-app).
